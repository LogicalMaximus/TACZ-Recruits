...
public class RecruitShootTACZGunGoal extends Goal {
    ...
    public RecruitShootTACZGunGoal(AbstractRecruitEntity recruit) {
    ...
    public boolean canUse() {
        ...
        if(this.target != null) {
            ...
            return shouldRanged && canAttack && notPassive;
        }
    ...
    public void tick() {
        if (this.target != null) {
            ...
            this.recruit.lookAt(EntityAnchorArgument.Anchor.EYES, TACZRecruitsUtils.randomizeVector(aimTarget.getEyePosition((float) Math.random()), TACZRecruitsUtils.getGunInaccuracy(this.recruit.getMainHandItem())));
